...
sudo cp /root/openshift-origin-aws/cloudapps.mylabsonline.com.db /var/named/dynamic/cloudapps.mylabsonline.com.db
sudo cp /root/openshift-origin-aws/mylabsonline.com.db /var/named/dynamic/mylabsonline.com.db
...
echo 'ns1.mylabsonline.com' | sudo tee --append /etc/hostname
echo 'HOSTNAME=ns1.mylabsonline.com' | sudo tee --append /etc/sysconfig/network
